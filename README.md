Employee finder -- assumming you work for a movie company (themed for fun)

upon entering the home website you have the options to look at the entire list of employees in a JSON format (parsed), or a button to link to the surey page where you enter your data (this effectively captures the users questionaire data and delivers the most closely similar employee based on their answers to the same set of questions)

the plot twist here is can you identify the characters that these emmployees emulated in their careers (yes for many movies)
...
Below is the original outline of the build instructions for this application which is closely adhered to 
